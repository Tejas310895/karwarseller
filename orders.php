          ...
          <div class="col-lg-12 col-md-6">
            <div class="card card-chart" style="border-radius:1.8rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="ref_bill.php?print=<?php echo $invoice_id; ?>&vendor_id=<?php echo $client_id; ?>" onclick="newWindow()" class="btn btn-info pull-right <?php if($client_id==6){ echo "show";}else{echo "d-none";}?>" style="padding: 11px 21px;">
                    <i class="now-ui-icons files_paper"></i>
                    KOT
                    </a>
